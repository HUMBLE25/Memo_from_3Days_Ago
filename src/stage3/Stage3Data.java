...
//                        .setMainCharacterImage(new ImageIcon("images/characters/명지훈_왼쪽.png"))
                ...
                new SceneData.Builder()
                        ...
                        .setProfileImage(new ImageIcon("images/characters/프_지훈.png"))
                        .setDialogue("김도진..?")
                        .setMainCharacterImage(new ImageIcon("images/characters/도진.png"))
                        .setSubCharacterImage(new ImageIcon("images/characters/명지훈_왼쪽.png"))
                        .build(),
                ...
                new SceneData.Builder()
                        ...
                        .setDialogue("마혜진..?")
                        .setSubCharacterImage(new ImageIcon("images/characters/명지훈_왼쪽.png"))
                        .setMainCharacterImage(new ImageIcon("images/characters/혜진.png"))
                        .build(),
