...
public class Start23 extends JFrame {
    ...
    public Start23() {
        ...
        setContentPane(new Start23.MyPanel());
    ...
    class MyPanel extends JPanel {
        ...
        public MyPanel() {
            ...
            // 대화 내용 텍스트
            JTextArea textArea = new JTextArea("전명호가 전화중이다. 뒤에 내가 있는 사실을 모르는 듯 하다.");
