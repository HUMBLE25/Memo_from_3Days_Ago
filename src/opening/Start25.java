...
public class Start25 extends JFrame {
    ...
    public Start25() {
        ...
        setContentPane(new Start25.MyPanel());
    ...
    class MyPanel extends JPanel {
        ...
        public MyPanel() {
            ...
            // 대화 내용 텍스트
            JTextArea textArea = new JTextArea("..지금 저 선배가 뭐라고 하고 있는 거지? 문성하가 알아서 처리된 거라고?");
